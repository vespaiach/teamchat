...
const StatusIndicator = ({ status }: { status: string }) => {
  ...
  return (
    <div className={`w-3 h-3 rounded-full ${colors[status as keyof typeof colors]} border-2 border-white dark:border-gray-800`} />
  );
};
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="flex items-center space-x-3">
                <div className="relative">
                  <div className="w-8 h-8 rounded-full flex items-center justify-center text-sm font-medium text-white" style={{ backgroundColor: 'var(--primary)' }}>
                    JD
                  </div>
          ...
          <div className="lg:col-span-1">
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 transition-colors duration-200">
              <div className="p-4 border-b border-gray-200 dark:border-gray-700">
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400">{users.filter(u => u.status === 'online').length} online</p>
              </div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-4 transition-colors duration-200">
            <div className="flex items-center">
              ...
              <div className="ml-3">
                ...
                <p className="text-lg font-semibold text-gray-900 dark:text-white">{users.filter(u => u.status === 'online').length}</p>
              </div>
            </div>
          </div>
